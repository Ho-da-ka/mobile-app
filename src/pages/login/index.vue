<template>
  <view class="login-container">
    <view class="login-header">
      <view class="logo-box">
        <up-icon name="account-fill" color="#2563eb" size="80rpx"></up-icon>
      </view>
    ...
    <view class="login-form">
      ...
      <up-form :model="form" ref="uForm">
        <up-form-item label="用户名" labelPosition="top" prop="username">
          <up-input
        ...
        <up-form-item label="密码" labelPosition="top" prop="password">
          <up-input
      ...
      <view class="login-tips">
        <up-icon name="info-circle" color="#94a3b8" size="28rpx"></up-icon>
